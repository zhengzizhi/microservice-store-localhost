...
import com.contoso.catalog.CatalogInfo;
import com.contoso.catalog.CatalogInfoRepository;
...
public class CatalogServiceV1 {
	...
	@Autowired
	public CatalogServiceV1(CatalogInfoRepository catalogInfoRepository, @LoadBalanced RestTemplate restTemplate) {
	...
	public Catalog getCatalog() {
		...
		catalog = restTemplate.getForObject(String.format(
	...
	public Product getProduct(String productId) {
		return restTemplate.getForObject(String.format("http://inventory-service/v1/products/%s", productId),
				Product.class);
	}
}